...
const Fourteen = ({
    ...
    // Lock scroll saat plaque menu terbuka (SSR Safe)
    useEffect(() => {
    ...
    return (
        <header className={`${!isBuild ? 'absolute top-0 md:top-4 left-0 px-4 md:px-6' : 'relative p-4 md:p-6'} z-[60] w-full flex justify-center pointer-events-none transition-all duration-500`}>
            ...
            <div className="relative w-full max-w-7xl pointer-events-auto">
                    ...
                    <div className="flex items-center gap-4 md:gap-6">
                        ...
                        <div className="flex md:hidden items-center">
                            <button
                                ...
                                aria-expanded={isPlaqueMenuOpen}
                                aria-label={isPlaqueMenuOpen ? "Tutup menu" : "Buka menu"}
                ...
                {isPlaqueMenuOpen && (
                    <>
                        {/* Backdrop transparan untuk menutup menu saat klik di luar area */}
                        <div
                            className="fixed inset-0 z-[5] md:hidden pointer-events-auto bg-black/10 backdrop-blur-[1px] transition-opacity"
