...
const Three = ({
    ...
    // Kunci scroll body saat drawer terbuka (Dengan pengamanan SSR)
    useEffect(() => {
    ...
    return (
        <>
            <header className={`${!isBuild ? 'absolute top-2 md:top-5 left-0 px-3 md:px-6' : 'relative p-4 md:p-6'} z-[60] w-full flex justify-center pointer-events-none transition-all duration-500`}>
                ...
                <div className={`pointer-events-auto w-full max-w-7xl flex items-center justify-between py-2.5 px-5 md:px-7 rounded-[1.25rem] border-[0.5px] backdrop-blur-2xl transition-all duration-500 ease-in-out ${isDarkMode
                    ...
                    <div className="hidden md:flex items-center gap-5 pl-2">
                        ...
                        <button
                            onClick={openScan}
                            className={`flex items-center gap-2 px-5 py-1.5 rounded-full border-[0.5px] transition-all duration-300 ${isDarkMode
            ...
            {isDrawerOpen && (
                <div className="fixed inset-0 z-[102] flex justify-end">
                    ...
                    {/* Right Panel Drawer */}
                    <div className={`relative w-[80%] max-w-[300px] h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-500 ease-out ${isDarkMode ? 'bg-slate-900 text-slate-100' : 'bg-white text-slate-900'
                        }`}>
                        {/* Drawer Header */}
                        ...
                        <div className="mt-auto p-6">
                            <button
                                ...
                                className={`w-full flex items-center justify-center gap-3 py-3.5 rounded-none border-[0.5px] transition-all ${isDarkMode
