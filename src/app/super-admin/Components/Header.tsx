"use client";
import { Bell, ChevronDown, LogOut, Menu, Settings, User, Crown, Zap, AlertCircle, Store, UserCircle } from 'lucide-react'
                ...
                <div className={`w-10 h-10 rounded-2xl flex items-center justify-center font-bold transition-all duration-500 relative ${planStatus === 'expired' || planStatus === 'canceled'
                  ...
                  }`}>
                  {
                    business?.logo_url ?
                      ...
                      <UserCircle size={24} className={`${planType === 'premium' ? 'text-slate-300' : "text-slate-100"}`} />
                  }
