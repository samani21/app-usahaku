...
// Import View Components lu
import ProductActive from './Views/ProductActive';
// Asumsi lu bakal bikin komponen ProductTrash juga:
import ProductTrash from './Views/ProductTrash';
